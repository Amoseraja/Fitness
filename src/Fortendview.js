...
import './Fortendview.css';

import fitnessImage from './image/edgar-chaparro-sHfo3WOgGTU-unsplash.jpg';
import running from './image/running.jpeg';
import yoga from './image/yoga.jpeg';
import jumping from './image/jumping.jpeg';
import wegithloss from './image/weigthloss.jpeg';
    ...
    <>
      <div className="header">
        <div className="container">
          <div className="navbar">
            ...
            <img src="lal-salaam5t." width="30px" height="30px" alt="logo" />
          </div>
          <div className="row">
            <div className="col-1">
      ...
      <div className="categories">
        <div className="small-container">
          <h1>Exercise</h1>
          <p>Improved Physical Health: Regular exercise strengthens your heart, muscles, and bones, enhances flexibility, and helps maintain a healthy weight.<br />Dicta quam accusamus in sint reprehenderit sunt.</p>
          <div className="row">
            <div className="col">
      ...
      <div className="offer">
        <div className="small-container">
          <div className="row">
            <div className="col-2">
              <img src={wegithloss} alt="Weight Loss Journey" width="1200px" height="300px" />
            </div>
            <div className="col-2">
              <p>Join our 90-day weight loss journey.</p>
              <h1>Naveen</h1>
              <small>Naveen, who currently weighs 120 kg, aims to reduce 20 kg in 90 days through consistent exercise and a balanced diet. Stay committed, and you'll see great results!<br /></small>
               <Link to="/login" className="btn">Login now</Link> 
